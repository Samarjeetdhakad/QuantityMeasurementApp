...
//	{
//
//	    System.out.println("Running Quantity Measurement Demo...");
//
//	}
  ...
  public void runDemo() 
  {
	...
	// UC1–UC4: Length equality — same unit and cross-unit comparisons
      ...
      checkEquality(new Quantity<>(1.0,   VolumneUnit.LITRE),       new Quantity<>(1.0,      VolumneUnit.LITRE));
      checkEquality(new Quantity<>(500.0, VolumneUnit.MILLILITRE),  new Quantity<>(500.0,    VolumneUnit.MILLILITRE));
      checkEquality(new Quantity<>(1.0,   VolumneUnit.GALLON),      new Quantity<>(1.0,      VolumneUnit.GALLON));
      checkEquality(new Quantity<>(1.0,   VolumneUnit.LITRE),       new Quantity<>(1000.0,   VolumneUnit.MILLILITRE));
      checkEquality(new Quantity<>(3.78541, VolumneUnit.LITRE),     new Quantity<>(1.0,      VolumneUnit.GALLON));
      checkEquality(new Quantity<>(0.264172, VolumneUnit.GALLON),   new Quantity<>(1.0,      VolumneUnit.LITRE));
      checkEquality(new Quantity<>(1000.0, VolumneUnit.MILLILITRE), new Quantity<>(0.264172, VolumneUnit.GALLON));

      // UC11: Volume unit-to-unit conversion
      demonstrateConversion(1.0,     VolumneUnit.LITRE,      VolumneUnit.MILLILITRE);
      demonstrateConversion(1000.0,  VolumneUnit.MILLILITRE, VolumneUnit.LITRE);
      demonstrateConversion(1.0,     VolumneUnit.GALLON,     VolumneUnit.LITRE);
      demonstrateConversion(2.0,     VolumneUnit.GALLON,     VolumneUnit.LITRE);
      demonstrateConversion(500.0,   VolumneUnit.MILLILITRE, VolumneUnit.GALLON);
      demonstrateConversion(3.78541, VolumneUnit.LITRE,      VolumneUnit.GALLON);

      // UC11: Volume Quantity-to-Quantity conversion
      demonstrateConversion(new Quantity<>(2.0, VolumneUnit.LITRE), VolumneUnit.MILLILITRE);

      // UC11: Volume addition with implicit target unit
      demonstrateAddition(1.0,   VolumneUnit.LITRE,      2.0,     VolumneUnit.LITRE);
      demonstrateAddition(1.0,   VolumneUnit.LITRE,      1000.0,  VolumneUnit.MILLILITRE);
      demonstrateAddition(500.0, VolumneUnit.MILLILITRE, 0.5,     VolumneUnit.LITRE);
      demonstrateAddition(2.0,   VolumneUnit.GALLON,     3.78541, VolumneUnit.LITRE);

      // UC11: Volume addition with explicit target unit
      demonstrateAddition(1.0,   VolumneUnit.LITRE,      1000.0,  VolumneUnit.MILLILITRE, VolumneUnit.MILLILITRE);
      demonstrateAddition(1.0,   VolumneUnit.GALLON,     3.78541, VolumneUnit.LITRE,      VolumneUnit.GALLON);
      demonstrateAddition(500.0, VolumneUnit.MILLILITRE, 1.0,     VolumneUnit.LITRE,      VolumneUnit.GALLON);
      demonstrateAddition(2.0,   VolumneUnit.LITRE,      4.0,     VolumneUnit.GALLON,     VolumneUnit.LITRE);
      ...
      demonstrateSubtraction(5.0, VolumneUnit.LITRE,      500.0, VolumneUnit.MILLILITRE);
      demonstrateSubtraction(1.0, VolumneUnit.LITRE,      1000.0, VolumneUnit.MILLILITRE);
      demonstrateSubtraction(2.0, VolumneUnit.GALLON,     3.78541, VolumneUnit.LITRE);

      // UC12: Volume subtraction with explicit target unit
      demonstrateSubtraction(5.0, VolumneUnit.LITRE, 2.0, VolumneUnit.LITRE, VolumneUnit.MILLILITRE);
      demonstrateSubtraction(5.0, VolumneUnit.LITRE, 2.0, VolumneUnit.LITRE, VolumneUnit.GALLON);
      ...
      demonstrateDivision(5.0,    VolumneUnit.LITRE,      10.0,  VolumneUnit.LITRE);
      demonstrateDivision(1000.0, VolumneUnit.MILLILITRE, 1.0,   VolumneUnit.LITRE);
      demonstrateDivision(1.0,    VolumneUnit.GALLON,     3.78541, VolumneUnit.LITRE);
